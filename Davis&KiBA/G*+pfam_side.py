...
class Model(NXmodelProto):
	def __init__(self, ERG, name):
		...
		self.sideHid1 = t.nn.Sequential(t.nn.Linear(136, P_SIDE_LATENT_SIZE), t.nn.LayerNorm(P_SIDE_LATENT_SIZE), ACTIVATION())
		self.sideMix1 = t.nn.Bilinear(PROT_LATENT_SIZE, P_SIDE_LATENT_SIZE, 50)			
		self.protHid = t.nn.Sequential(t.nn.Linear(50, SIZE1), t.nn.LayerNorm(SIZE1), ACTIVATION())
